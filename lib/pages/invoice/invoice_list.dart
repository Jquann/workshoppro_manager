...
class _InvoiceListState extends State<InvoiceList> {
  ...
  bool _checkFilterMatch(Invoice invoice) {
    switch (selectedFilterType) {
      case 'Vehicle':
        return invoice.vehiclePlate == selectedFilterValue;
      case 'Customer':
        return invoice.customerName == selectedFilterValue;
      case 'Mechanic':
  ...
  List<String> get _filterValues {
    ...
    for (var invoice in allInvoices) {
      switch (selectedFilterType) {
        case 'Vehicle':
          values.add(invoice.vehiclePlate);
          break;
        case 'Customer':
          values.add(invoice.customerName);
          break;
        case 'Mechanic':
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: () async {
                                ...
                                // Note: No need to manually refresh here as we're using real-time streams
                              },
                              child: Card(
